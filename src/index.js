...
app.post('/posts', async (req, res) => {
  ...
  const{ titulo, contenido, fecha_publicacion, imagen_base64, carro_id } = req.body;
    ...
    app.put('/posts/:postId', async (req, res) => {
        ...
        const { titulo, contenido, fecha_publicacion, imagen_base64, carro_id } = req.body; // Extrae la información actualizada del cuerpo de la solicitud
